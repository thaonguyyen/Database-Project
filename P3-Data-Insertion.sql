...
-- Insertion for Destination_Activity
...
-- Insertion for Hotel
INSERT INTO Hotel (hotel_id, destination_id, name, price_range) VALUES 
    (1, 1, 'The Plaza Hotel', '$$$'),
    (2, 1, 'Holiday Inn Express Manhattan Times Square', '$$'),
    (3, 1, 'Hotel Pennsylvania', '$'),
    (4, 2, 'The Beverly Hills Hotel', '$$$'),
    (5, 2, 'Hilton Los Angeles Airport', '$$'),
    (6, 2, 'Super 8 by Wyndham Los Angeles', '$'),
    (7, 3, 'The Langham Chicago', '$$$'),
    (8, 3, 'Hampton Inn Chicago Downtown/N Loop/Michigan Ave', '$$'),
    (9, 3, 'Travelodge by Wyndham Downtown Chicago', '$'),
    (10, 4, 'The Post Oak Hotel at Uptown Houston', '$$$'),
    (11, 4, 'Hilton Houston Plaza/Medical Center', '$$'),
    (12, 4, 'Motel 6 Houston Medical Center', '$'),
    (13, 5, 'The Phoenician - a Luxury Collection Resort', '$$$'),
    (14, 5, 'Hampton Inn Phoenix Airport North', '$$'),
    (15, 5, 'Red Roof PLUS+ Phoenix West', '$'),
    (16, 6, 'The Rittenhouse Hotel', '$$$'),
    (17, 6, 'Hilton Philadelphia at Penn''s Landing', '$$'),
    (18, 6, 'Days Inn by Wyndham Philadelphia Convention Center', '$'),
    (19, 7, 'Mokara Hotel & Spa', '$$$'),
    (20, 7, 'Drury Inn & Suites San Antonio Riverwalk', '$$'),
    (21, 7, 'La Quinta Inn by Wyndham San Antonio Market Square', '$'),
    (22, 8, 'Hotel del Coronado', '$$$'),
    (23, 8, 'Hyatt Regency La Jolla', '$$'),
    (24, 8, 'Motel 6 San Diego Downtown', '$'),
    (25, 9, 'Four Seasons Hotel Miami', '$$$'),
    (26, 9, 'Hilton Miami Downtown', '$$'),
    (27, 9, 'Red Roof PLUS+ Miami Airport', '$'),
    (28, 10, 'The Fairmont San Jose', '$$$'),
    (29, 10, 'Hilton San Jose', '$$'),
    (30, 10, 'Motel 6 San Jose Airport Central', '$'),
    (31, 11, 'The Driskill', '$$$'),
    (32, 11, 'Hampton Inn & Suites Austin-Downtown', '$$'),
    (33, 11, 'Motel 6 Austin Central-North', '$'),
    (34, 12, 'Four Seasons Resort Orlando at Walt Disney World', '$$$'),
    (35, 12, 'Hilton Orlando Buena Vista Palace', '$$'),
    (36, 12, 'Days Inn by Wyndham Orlando Conv. Center/International Dr', '$'),
    (37, 13, 'The Ritz-Carlton - Dallas', '$$$'),
    (38, 13, 'Hilton Garden Inn Downtown Dallas', '$$'),
    (39, 13, 'Motel 6 Dallas Downtown', '$'),
    (40, 14, 'Hotel LeVeque - Autograph Collection', '$$$'),
    (41, 14, 'Hyatt Regency Columbus', '$$'),
    (42, 14, 'Motel 6 Columbus West', '$'),
    (43, 15, 'The Ballantyne - A Luxury Collection Hotel - Charlotte', '$$$'),
    (44, 15, 'Embassy Suites by Hilton Charlotte', '$$'),
    (45, 15, 'Motel 6 Charlotte University', '$'),
    (46, 16, 'Fairmont San Francisco', '$$$'),
    (47, 16, 'Hilton San Francisco Union Square', '$$'),
    (48, 16, 'Travelodge by Wyndham San Francisco Bay', '$'),
    (49, 17, 'Conrad Indianapolis', '$$$'),
    (50, 17, 'Hilton Garden Inn Indianapolis Downtown', '$$'),
    (51, 17, 'Motel 6 Indianapolis Airport', '$'),
    (52, 18, 'Fairmont Olympic Hotel', '$$$'),
    (53, 18, 'Hyatt at Olive 8', '$$'),
    (54, 18, 'Motel 6 Seattle Airport', '$'),
    (55, 19, 'The Ritz-Carlton - Denver', '$$$'),
    (56, 19, 'Hilton Denver City Center', '$$'),
    (57, 19, 'Motel 6 Denver Central - Federal Blvd', '$'),
    (58, 20, 'The Willard InterContinental Washington D.C.', '$$$'),
    (59, 20, 'Hilton Washington D.C. Capitol Hill', '$$'),
    (60, 20, 'Red Roof PLUS+ Washington DC', '$'),
    (61, 21, 'Four Seasons Hotel Boston', '$$$'),
    (62, 21, 'Hyatt Regency Boston', '$$'),
    (63, 21, 'Motel 6 Boston - Danvers', '$'),
    (64, 22, 'The Biltmore Hotel', '$$$'),
    (65, 22, 'Hilton Miami Downtown', '$$'),
    (66, 22, 'Super 8 by Wyndham Miami', '$'),
    (67, 23, 'The Mandarin Oriental - New York', '$$$'),
    (68, 23, 'Hilton New York', '$$'),
    (69, 23, 'Econo Lodge Times Square', '$'),
    (70, 24, 'The Ritz-Carlton - Washington D.C.', '$$$'),
    (71, 24, 'Holiday Inn Washington-Capitol', '$$'),
    (72, 24, 'Motel 6 Washington D.C.', '$'),
    (73, 25, 'The Cosmopolitan of Las Vegas', '$$$'),
    (74, 25, 'Planet Hollywood Resort & Casino', '$$'),
    (75, 25, 'Motel 6 Las Vegas Tropicana', '$'),
    (76, 26, 'The Nines - a Luxury Collection Hotel - Portland', '$$$'),
    (77, 26, 'Embassy Suites by Hilton Portland Downtown', '$$'),
    (78, 26, 'Motel 6 Portland Downtown', '$'),
    (79, 27, 'The Peabody Memphis', '$$$'),
    (80, 27, 'Hilton Memphis', '$$'),
    (81, 27, 'Motel 6 Memphis Downtown', '$'),
    (82, 28, 'Skirvin Hilton Hotel', '$$$'),
    (83, 28, 'Hilton Garden Inn Oklahoma City Downtown', '$$'),
    (84, 28, 'Motel 6 Oklahoma City North Frontier City', '$'),
    (85, 29, '21c Museum Hotel Louisville', '$$$'),
    (86, 29, 'Hilton Garden Inn Louisville Downtown', '$$'),
    (87, 29, 'Motel 6 Louisville North', '$'),
    (88, 30, 'Four Seasons Hotel Baltimore', '$$$'),
    (89, 30, 'Hilton Baltimore Inner Harbor', '$$'),
    (90, 30, 'Motel 6 Baltimore Downtown', '$');
...
FROM '/tmp/itinerary_picked_hotel.csv'
WITH (
    FIELDTERMINATOR = ',',
    ROWTERMINATOR = '\n',
    FIRSTROW = 2
...
FROM '/tmp/itinerary_picked_activity.csv'
WITH (
    FIELDTERMINATOR = ',',
    ROWTERMINATOR = '\n',
    FIRSTROW = 2
...
-- These rows do not work 
-- ('ATL', 1036, '13:30:00', '16:00:00', 'Southwest', 'MCO')
-- ('JFK', 1003, '07:00:00', '09:30:00', 'United', 'LGA'),


INSERT INTO Flight (airport_id, flight_id, departure_time, arrival_time, airline, arrival_airport_id) VALUES
    
    ('JFK', 1001, '06:00:00', '08:30:00', 'Delta', 'PHL'),
    ('DFW', 1037, '14:00:00', '16:30:00', 'JetBlue', 'ORD'),
    ('DFW', 1038, '15:30:00', '18:00:00', 'Spirit', 'SDF'),
    ('DFW', 1039, '17:00:00', '19:30:00', 'Frontier', 'IAH'),
    ('CMH', 1041, '19:45:00', '22:15:00', 'Delta', 'CLT'),
    ('CLT', 1043, '07:00:00', '09:30:00', 'United', 'SEA'),
    ('IAD', 1044, '08:30:00', '11:00:00', 'Southwest', 'CLT'),
    ('JFK', 1002, '08:00:00', '10:30:00', 'American Airlines', 'ORD'),
    ('LAX', 1004, '09:30:00', '11:45:00', 'Southwest', 'PHX'),
    ('SFO', 1005, '05:45:00', '08:15:00', 'JetBlue', 'LAX'),
    ('LAX', 1006, '10:15:00', '12:45:00', 'Spirit', 'LAS'),
    ('ORD', 1007, '11:00:00', '13:30:00', 'Frontier', 'SEA'),
    ('LAX', 1008, '14:30:00', '17:00:00', 'Alaska', 'ORD'),
    ('ORD', 1009, '16:00:00', '18:30:00', 'Delta', 'PHX'),
    ('IAH', 1010, '18:15:00', '20:45:00', 'American Airlines', 'JFK'),
    ('IAH', 1011, '20:30:00', '23:00:00', 'United', 'MIA'),
    ('IAH', 1012, '22:00:00', '01:00:00', 'Southwest', 'ORD'),
    ('PHX', 1013, '09:00:00', '11:30:00', 'JetBlue', 'AUS'),
    ('PHX', 1014, '10:30:00', '13:00:00', 'Spirit', 'LAX'),
    ('PHX', 1015, '11:45:00', '14:45:00', 'Frontier', 'DEN'),
    ('PHL', 1016, '13:15:00', '16:00:00', 'Alaska', 'SAT'),
    ('PHL', 1017, '07:45:00', '10:15:00', 'Delta', 'JFK'),
    ('PHL', 1018, '06:30:00', '09:00:00', 'American Airlines', 'SAT'),
    ('SAT', 1019, '09:15:00', '11:45:00', 'United', 'PHL'),
    ('SAT', 1020, '14:45:00', '17:15:00', 'Southwest', 'SAN'),
    ('LAX', 1021, '09:30:00', '12:00:00', 'JetBlue', 'DFW'),
    ('LAS', 1022, '08:00:00', '10:30:00', 'Spirit', 'SAN'),
    ('SAN', 1023, '12:30:00', '14:45:00', 'Frontier', 'PHX'),
    ('MIA', 1026, '20:00:00', '22:30:00', 'American Airlines', 'IAH'),
    ('MIA', 1027, '06:15:00', '08:45:00', 'United', 'MCO'),
    ('SJC', 1030, '18:45:00', '21:00:00', 'Spirit', 'SFO'),
    ('AUS', 1031, '06:00:00', '08:30:00', 'Frontier', 'PHX'),
    ('SFO', 1046, '11:00:00', '13:30:00', 'Spirit', 'MCO'),
    ('SFO', 1047, '12:30:00', '15:00:00', 'Frontier', 'SJC'),
    ('SEA', 1052, '08:00:00', '10:30:00', 'Southwest', 'BWI'),
    ('SEA', 1053, '09:30:00', '12:00:00', 'JetBlue', 'PDX'),
    ('SEA', 1054, '10:30:00', '13:00:00', 'JetBlue', 'SFO'),
    ('DEN', 1056, '14:00:00', '16:30:00', 'Alaska', 'DFW'),
    ('DEN', 1057, '15:30:00', '18:00:00', 'Delta', 'OKC'),
    ('IAD', 1058, '17:00:00', '19:30:00', 'American Airlines', 'LAX'),
    ('IAD', 1060, '08:00:00', '10:30:00', 'Southwest', 'BNA'),
    ('BOS', 1061, '09:30:00', '12:00:00', 'JetBlue', 'JFK'),
    ('BOS', 1062, '11:00:00', '13:30:00', 'Spirit', 'IND'),
    ('BWI', 1089, '15:30:00', '18:00:00', 'Delta', 'OKC'),
    ('PDX', 1076, '08:00:00', '10:30:00', 'Southwest', 'SFO');